package com.teamsorcerers.wizardry.common.utils

import com.teamsorcerers.wizardry.common.utils.WNBT.getFloat
...
object WNBT {
    ...
    fun ItemStack.getFloat(key: String, defaultValue: Float): Float {
        var wrapper = Registries.REGISTRIES.tagCreatingWrapper;
        RegistryWrapper.WrapperLookup.of(wrapper.withFeatureFilter(
            FeatureSet.empty()
        ).to())
    }
