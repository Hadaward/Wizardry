...
class BlockWorktable(settings: Settings?) : HorizontalFacingBlock(settings), Waterloggable {
    ...
    override fun getPlacementState(context: ItemPlacementContext): BlockState? {
        ...
        val direction: Direction = context.playerLookDirection.rotateYClockwise()
    ...
    override fun onPlaced(world: World, pos: BlockPos, state: BlockState, placer: LivingEntity?, stack: ItemStack) {
     ...
     fun getPistonBehavior(state: BlockState): PistonBehavior {
    ...
    override fun onUseWithItem(
        ...
        if (world != null && world.isClient) Wizardry.PROXY.openWorktableGui()
