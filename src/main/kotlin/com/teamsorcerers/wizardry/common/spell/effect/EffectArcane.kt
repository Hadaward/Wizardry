package com.teamsorcerers.wizardry.common.spell.effect
...
import com.teamsorcerers.wizardry.common.spell.component.Attributes
...
import com.teamsorcerers.wizardry.common.spell.component.PatternEffect
...
class EffectArcane : PatternEffect() {
    override fun affectEntity(world: World, entity: Interactor, instance: Instance) {
        ...
        entity.entity?.damage(Wizardry.getDamageSource(world, DamageTypes.MAGIC), instance.getAttributeValue(Attributes.INTENSITY).toFloat() * POTENCY_MULTIPLIER)
